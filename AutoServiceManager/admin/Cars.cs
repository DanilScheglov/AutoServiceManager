...
namespace AutoServiceManager.admin
{
    public partial class Cars : helpers.BaseForm, helpers.IUpdateContract
    {
        ...
        public void onUpdateUI()
        {
            ...
            carsDataGridView.ColumnHeadersDefaultCellStyle.Font = new Font("Microsoft Sans Serif", 11);
            carsDataGridView.Columns[2].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            carsDataGridView.ColumnHeadersHeight = 40;
